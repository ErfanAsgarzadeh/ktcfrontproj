...
import { ProjectNode, ActivityNode, Dependency, CustomUser, TaskRole } from '../types/types';
...
export default function TaskDetailsPanel({
  ...
  return (
    <div className="h-full bg-transparent text-slate-200 flex flex-col overflow-hidden border-l border-white/5 select-none">
      {/* Inspector Header */}
